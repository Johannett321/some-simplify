...
public class PostService {
    ...
    @Transactional
    public void generatePosts(Tenant tenant) {
        tenant.getContentFiles().forEach(this::generateSinglePost);
    }
    ...
    public String generateTextForPost(ContentFile contentFile) {
        String system = """
                Du er en markedsførings agent som lager tekst til {platform} innlegg. Når en bruker sender deg et bilde,
                skriver du en tekst som passer til dette bildet og som bedriften kan bruke som tekst til innlegget.
